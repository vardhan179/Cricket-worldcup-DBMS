...
<div style="margin-top:10px; style : center" ><table width="fit" align="center" style="background-color:khaki;"><tr style="background-color:darksalmon;"><th><p style="align-content: center;"><h1 style="color:">CRICKET BOARDS </h1></p></th></tr><tr style="background-color:darksalmon;"><th>
	<table align="center">
		<tr >
			<th>Board Name</th>
			<th>Chairman</th>
		...
		if(mysqli_num_rows($result)>0)
		{
			...
			$row["team"]."</th><th>".
			$row["DOA"]."</th>
			<th height="."100%"."><img src=".$row["flag"]." width="."100px"."></th>
			</tr>";
			}
		}
		mysqli_close($con);
